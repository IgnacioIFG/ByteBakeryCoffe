   ...
   <div class="container-fluid p-0 nav-bar">
    ...
    <div class="container-fluid page-header mb-5 position-relative overlay-bottom">
        <div class="d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5" style="min-height: 300px">
            <h1 class="display-4 mb-3 mt-0 mt-lg-5 text-white text-uppercase">Who We Are ?</h1>
        </div>
    </div>
    <!-- Page Header End -->
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 py-0 py-lg-5">
					...
					<p>Nestled in the heart of the bustling city, Byte Bakery Coffee was born from a passion for exceptional brews and a love for community. Founded by a group of friends who traveled the world in search of the perfect coffee beans, they brought their discoveries back home.</p>                    <a href="" class="btn btn-secondary font-weight-bold py-2 px-4 mt-2">Learn More</a>
                ...
                <div class="col-lg-4 py-0 py-lg-5">
					...
					<p>Our vision is to create a welcoming sanctuary where coffee enthusiasts and casual visitors alike can gather, connect, and unwind.</p>                   
