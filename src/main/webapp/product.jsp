...
<%
	...
	Producto product = bd.dameProducto(Integer.parseInt(idProducto));
...
<body>
 ...
 <div class="wrapper">
    <div class="product-img">
      <img src="img/products/<%=product.getIdProducto() %>.png" height="420" width="327">
    </div>
    <div class="product-info">
      <div class="product-text">
        <h1><%=product.getNombre_producto() %></h1>
        <h2>by ByteBakeryCoffee</h2>
        <p><%=product.getDescripcion()%></p>
      </div>
      <div class="product-price-btn" style="margin-left: 15px;">
    ...
    <div class="section-title">
        <h4 class="text-primary text-uppercase" style="letter-spacing: 5px;">sales lines</h4>
    
    </div>
    <div class="contenedor_tablas_detalle">
        <h1>Lineas de venta del producto</h1>
        <table class="tablaEntera" >
            <tr>
                <th >ID Linea</th>
                <th >ID venta</th>
                <th >ID Poducto</th>
            ...
            <% for(LineaVenta l: bd.dameLineasVentaPorProducto(product.getIdProducto())){ %>
