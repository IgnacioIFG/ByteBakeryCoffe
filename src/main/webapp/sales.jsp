...
.contenedor-img-producto-datos {
    ...
    height: 100vh;
    gap: 2rem; /* Separación entre la imagen y la lista */
...
.datosProducto {
    margin-top: 0; /* Para eliminar el margen superior añadido anteriormente */
    margin-right: 470px;
}
...
.coffee-shop-button:hover {
    ...
    transform: scale(1.05); /* Agrandar un poco el botón al pasar el cursor */
}
