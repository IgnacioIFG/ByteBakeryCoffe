...
if(tipoOperacion.equalsIgnoreCase("editProduct")){
	int id_product=0;
	id_product=Integer.parseInt(request.getParameter("id_product"));
	
	prod = controlador.dameProducto(id_product);
   ...
   <div class="container-fluid p-0 nav-bar">
    ...
    <div class="container-fluid page-header mb-5 position-relative overlay-bottom">
        <div class="d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5" style="min-height: 300px">
            <h1 class="display-4 mb-3 mt-0 mt-lg-5 text-white"><%=prod.getNombre_producto()%></h1>
    ...
    <!-- Edit the product start -->
    <div class="offer container-fluid my-5 py-5 text-center position-relative overlay-top overlay-bottom">
        <div class="container py-5">
            <div class="col-lg-6 mx-auto form-container"> <!-- Clase específica para centrar el formulario -->
                <div class="text-center p-5" style="background: rgba(51, 33, 29, .8);">
                    <h1 class="text-white mb-4 mt-5">Edit "<%=prod.getNombre_producto()%>"</h1>
                    <!-- Formulario de alta de producto -->
                    <form class="mb-5" action="operaciones.jsp?tipo=editProductEspecific" method="post">
