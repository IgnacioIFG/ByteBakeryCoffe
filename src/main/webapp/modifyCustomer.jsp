...
%>
    ...
    <div class="container-fluid page-header mb-5 position-relative overlay-bottom">
        <div class="d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5" style="min-height: 300px">
            <h1 class="display-4 mb-3 mt-0 mt-lg-5 text-white text-uppercase">Modify Customer</h1>
    ...
    <div class="offer container-fluid my-5 py-5 text-center position-relative overlay-top overlay-bottom">
        ...
        <div class="text-center p-5" style="background: rgba(51, 33, 29, .8); border: 2px solid #daa05d; ">
            <h1 class="text-white mb-4 mt-5">Modificar Cliente</h1>
            <form class="mb-5" action="operaciones.jsp?tipo=modificacioncliente" method="post">
            <!-- Cada uno de los siguientes divs representa un campo del formulario. Cada campo tiene un valor predeterminado que se obtiene de un objeto 'cliente' -->
                <div class="form-group">
                    <input type="text" value="<%=customer.getDni()%>" class="textito form-control bg-transparent border-primary p-4" name="dni" id="dni" placeholder="DNI" required="required" maxlength="9"/>
                </div>
                <div class="form-group">
                    <input type="text" value="<%=customer.getNombre() %>" class="textito form-control bg-transparent border-primary p-4" name="nombre" id="nombre" placeholder="Nombre" required="required" maxlength="20"/>
                </div>
                <div class="form-group">
                    <input type="text" value="<%=customer.getApellidos() %>" class="textito form-control bg-transparent border-primary p-4" name="apellidos" id="apellidos" placeholder="Apellidos" required="required"maxlength="20" />
                </div>
                <div class="form-group">
                    <input type="text" value="<%=customer.getDireccion() %>" class="textito form-control bg-transparent border-primary p-4" name="direccion" id="direccion" placeholder="Dirección" required="required" maxlength="50" />
                </div>
                <div class="form-group">
                    <input type="text" value="<%=customer.getCp()%>" class="textito form-control bg-transparent border-primary p-4" name="cp" id="cp" placeholder="CP" required="required" />
                </div>
                <div class="form-group">
                    <input type="text" value="<%=customer.getProvincia()  %>" class="textito form-control bg-transparent border-primary p-4" name="provincia" id="provincia" placeholder="Provincia" required="required" maxlength="50"/>
                </div>
                <div>
                	<input type="hidden" name="id_cliente" id="id_cliente" value="<%=customer.getIdCliente()%>">
