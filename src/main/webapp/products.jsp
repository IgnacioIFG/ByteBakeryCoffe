   ...
   <div class="container-fluid p-0 nav-bar">
    ...
    <div class="container-fluid page-header mb-5 position-relative overlay-bottom">
        <div class="d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5" style="min-height: 100px">
            <h1 class="display-4 mb-3 mt-0 mt-lg-5 text-white text-uppercase">All our products</h1>
        </div>
    </div>
    <!-- Page Header End -->
    ...
    <div class="container-fluid pt-5">
        <div class="container">
            ...
            ArrayList<Producto>productos = bd.todosProductos();
            ArrayList<String>tipos=bd.dameTiposProductos();
            
            for (int i=0; i<tipos.size(); i++) {
            %>
            
                <div class="col-lg-6">
                <h1 class="mb-5"><%=tipos.get(i)%></h1>
                 <% for (Producto producto : bd.productosPorCategoria(tipos.get(i))) { %>
                
              
                    <div class="row align-items-center mb-5">
                        <div class="col-4 col-sm-3 ">
                        <a href="product.jsp?idProducto=<%=producto.getIdProducto()%>" class m ="navbar-brand px-lg-4 m-0">
                             <img class="w-100 rounded-circle mb-3 mb-sm-0" src="img/products/<%=producto.getIdProducto()%>.png" alt="">
                        	 <h5 class="menu-price">$<%=producto.getPrecio()%></h5>
                        </a>
                        ...
                        <div class="col-8 col-sm-9">
                         <a href="product.jsp?idProducto=<%=producto.getIdProducto()%>" class m ="navbar-brand px-lg-4 m-0">
                             <h4><%= producto.getNombre_producto() %></h4>
                        </a>
                        
                        <p class="m-0"><%=producto.getDescripcion() %></p>
                    </div>
                    </div>
