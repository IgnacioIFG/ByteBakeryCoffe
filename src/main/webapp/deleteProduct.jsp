   ...
   <div class="container-fluid p-0 nav-bar">
    ...
    <div class="container-fluid page-header mb-5 position-relative overlay-bottom">
        <div class="d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5" style="min-height: 300px">
            <h1 class="display-4 mb-3 mt-0 mt-lg-5 text-white">What are you going to delete?</h1>
        ...
        <div class="container py-5">
            <div class="col-lg-6 mx-auto form-container"> <!-- Clase específica para centrar el formulario -->
		        <div class="text-center p-5" style="background: rgba(51, 33, 29, .8);">
		            <h1 class="text-white mb-4 mt-5">Delete Product</h1>
		            <!-- Formulario de baja de producto -->	
		           <form id="bajaClienteForm" action="operaciones.jsp?tipo=deleteProduct" method="post">
					    ...
					    <div class="button-container">
					        ...
					        <button class="btn btn-primary btn-block font-weight-bold py-3" type="submit" >Delete</button>
					    </div>
					</form>
             	</div>
          	</div>
